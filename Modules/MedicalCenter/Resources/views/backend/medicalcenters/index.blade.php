                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("medicalcenter::text.name")
                            </th>
                            <th>
                                @lang("medicalcenter::text.updated_at")
                            </th>
                            <th>
                                @lang("medicalcenter::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("medicalcenter::text.action")
                            </th>
                        </tr>
                    </thead>

                    <tbody>
                        @foreach($medicalcares as $module_name_singular)
                        <tr>
                            <td>
        ...
        <div class="row">
            <div class="col-7">
                <div class="float-left">
                    Total {{ $medicalcares->total() }} {{ ucwords($module_name) }}
                </div>
            </div>
            <div class="col-5">
                <div class="float-end">
