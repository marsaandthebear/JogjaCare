...
private function generateUniqueUsername($firstName, $lastName)
{
     ...
     * @return \Illuminate\Http\RedirectResponse The redirect response to the admin module.
     *
     * @throws \Symfony\Component\HttpKernel\Exception\NotFoundHttpException If the authenticated user does not have the 'edit_users' permission.
     */
     ...
     * @return \Illuminate\Http\RedirectResponse The redirect back to the previous page.
     *
    ...
    public function emailConfirmationResend($id)
    {
        ...
        // Tambahkan return default jika user tidak ditemukan
